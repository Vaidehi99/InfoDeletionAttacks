...
REMOTE_URL = f"{REMOTE_ROOT_URL}/data/dsets/counterfact_filtered_paraphrases.json"


class CounterFactDataset_filtered_paraphrases(Dataset):
    def __init__(
        self, data_dir: str, size: typing.Optional[int] = None, *args, **kwargs
    ):
        data_dir = Path(data_dir)
        cf_loc = data_dir / "counterfact_filtered.json"
